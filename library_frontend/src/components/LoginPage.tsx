        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-amber-500/30">
              ...
              <span className="text-amber-500 text-xs uppercase tracking-wider font-semibold">Library Portal</span>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 relative flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md relative z-10">
            ...
            <div className="px-8 pt-8 pb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="text-center pt-4">
                  <a href="/register" className="text-amber-400/60 hover:text-amber-400 text-sm transition-colors">
          ...
          <div className="mt-6 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-full backdrop-blur-sm border border-white/10">
              <svg className="w-3 h-3 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="text-white/50 text-xs">Secure access • Encrypted connection</span>
            </div>
          </div>
        </div>
      </div>
