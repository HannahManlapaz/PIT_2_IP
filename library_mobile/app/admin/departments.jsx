...
export default function DepartmentsScreen() {
  ...
  const openEdit = (dept) => {
    ...
    setEditing(dept); setError(''); setShowForm(true);
  };
  ...
  const renderItem = ({ item: dept, index }) => (
    <View style={[s.card, index % 2 === 0 ? { backgroundColor: C.white } : { backgroundColor: '#fdf9f4' }]}>
      <View style={s.cardLeft}>
        ...
        <View style={s.cardInfo}>
          ...
          {!!dept.description && (
            <Text style={s.deptDesc} numberOfLines={2}>{dept.description}</Text>
          )}
        </View>
      </View>
  ...
  if (loading) return (
    <View style={s.centerState}>
      ...
      <Text style={s.centerStateText}>Loading departments…</Text>
    </View>
  );
    ...
    <View style={s.container}>
      ...
      <View style={s.header}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={s.pageSubtitle}>Manage college departments</Text>
        </View>
      ...
      {filtered.length === 0 ? (
        <View style={s.emptyState}>
          ...
          <Text style={s.emptyBody}>Add a department to classify books by college.</Text>
        </View>
      ) : (
        <FlatList
          data={filtered}
      ...
      <BottomSheetModal
        ...
        <View style={s.fieldWrap}>
          ...
          <TextInput
            ...
            placeholder="e.g. College of Engineering, Nursing…"
            placeholderTextColor={C.textMuted}
      ...
      <BottomSheetModal
        ...
        <View style={s.confirmBody}>
          ...
          <Text style={s.confirmNote}>
            Books assigned to this department will not be deleted — they'll just have no department assigned.
          </Text>
        </View>
      </BottomSheetModal>
    </View>
...
const s = StyleSheet.create({
  ...
  cardInfo:    { flex: 1 },
  deptName:    { fontSize: 14, fontWeight: '700', color: C.textDark, marginBottom: 2 },
  deptDesc:    { fontSize: 12, color: C.textMuted, fontStyle: 'italic' },
